...
from legislator_test_utility_functions import add_dummy_party, add_dummy_state, add_dummy_legislator, remove_dummy_legislators, remove_dummy_parties, remove_dummy_states
...
class TestBillSearch(TestCase):
    ...
    def setUpClass(cls):
        ...
        add_dummy_state('dummy_acronym3', 'Yorknew')
